...
import CircleProgressElement from './CircleProgress'
    ...
    setup(props, { slots }) {
        ...
        const getBackground = (color?: string | string[] | Record<string, string>) => {
            ...
            if (!Array.isArray(color)) {
                const colors = Object.entries(color).map(colorItem => `${colorItem[1]} ${colorItem[0]}`)
        ...
        const color = computed(() => getBackground(props.color))
        const backgroundColor = computed(() => getBackground(props.backgroundColor))
        ...
        return () => {
            ...
            const HorizontalProgress = (
                <div class="o-progress__outer" style={{
                    height: size.value,
