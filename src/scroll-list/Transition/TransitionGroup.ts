...
const newPositionMap = new WeakMap<VNode, { left: number, top: number }>()
...
const TransitionGroupImpl: ComponentOptions = {
    ...
    setup(props: TransitionGroupProps, { slots }: SetupContext) {
        ...
        if (prevChildren) {
            ...
            positionMap.set(child, { left: el.offsetLeft, top: el.offsetTop })
            }
        }
...
function recordPosition(c: VNode) {
    ...
    newPositionMap.set(c, { left: el.offsetLeft, top: el.offsetTop })
}
